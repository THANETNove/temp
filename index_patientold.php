...
h1 {
    ...
    <!-- Masthead-->
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">Sign in</a> 
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">choose for log in                </h3>
                </div>
				</p>
                <div class="row text-center">
                  <div >
					  <a href="login_patient.php" </a>
                        <p><span class="fa-stack fa-4x">
                          <i href = "img/patient.png"></i>
                        </span>
                         
                        <p><img src="img/patient.png" width="160" height="160" alt=""/></p>
                        <h4 class="my-3">PATIENT  </h4> 
                       
                  </div>
                    <div >
						<a href="login_doctor.php"</a>
                        <span class="fa-stack fa-4x">
                            
                        </span>	
                        <h4 class="my-3"><img src="img/doctor.png" width="160" height="160" alt=""/></h4>
                        <h4 class="my-3">DOCTOR                    </h4>
                    </div>
                  <div > 
					 <div class="text-center">
    <a href="login_admin.php">
        ...
        <h4 class="my-3">
            <img src="img/admin.png" width="160" height="160" alt=""/>
        </h4>
            ...
            <div class="row">
              <div class="col-lg-4 col-sm-6 mb-4">
                ...
                <div class="portfolio-item"> <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                  ...
                  <img class="img-fluid" src="assets/img/portfolio/1.jpg" alt="..." /> </a>
              ...
              <div class="col-lg-4 col-sm-6 mb-4">
                ...
                <div class="portfolio-item"> <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                  ...
                  <img class="img-fluid" src="assets/img/portfolio/2.jpg" alt="..." /> </a>
                  <div class="portfolio-caption">
              ...
              <div class="col-lg-4 col-sm-6 mb-4">
                ...
                <div class="portfolio-item"> <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal3">
                  ...
                  <img class="img-fluid" src="assets/img/portfolio/3.jpg" alt="..." /> </a>
                  <div class="portfolio-caption">
              ...
              <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                ...
                <div class="portfolio-item"> <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal4">
                  ...
                  <img class="img-fluid" src="assets/img/portfolio/4.jpg" alt="..." /> </a>
                  <div class="portfolio-caption">
              ...
              <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                ...
                <div class="portfolio-item"> <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal5">
                  ...
                  <img class="img-fluid" src="assets/img/portfolio/5.jpg" alt="..." /> </a>
                  <div class="portfolio-caption">
              ...
              <div class="col-lg-4 col-sm-6">
                ...
                <div class="portfolio-item"> <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal6">
                  ...
                  <img class="img-fluid" src="assets/img/portfolio/6.jpg" alt="..." /> </a>
                  <div class="portfolio-caption">
        ...
        <!-- Team-->
    <section class="page-section bg-light" id="team"></section>
        <!-- Clients-->
        <div class="py-5">
            <div class="container">
          ...
          <div class="text-center">
            ...
            <h3 class="section-subheading text-muted">Personal Information.</h3>
              ...
              <input class="form-control" id="number" type="number" placeholder="อายุ" data-sb-validations="required," />
                            ...
                            <p>
                              <input class="form-control" id="number" type="number" placeholder="น้ำหนัก" data-sb-validations="required," />
                            </p>
                            <p>
                              <input class="form-control" id="number" type="number" placeholder="ส่วนสูง" data-sb-validations="required," />
                            </p>
                            <p>
                              <input class="form-control" id="text" type="text" placeholder="ประวัติแพ้ยา*" data-sb-validations="required,email" />
                            </p>
                            <p>
                              <input class="form-control" id="text" type="text" placeholder="โรคประจำตัว" data-sb-validations="required," />
                            </p>
            <p>
                              <input class="form-control" id="text" type="text" placeholder="ที่อยู่" data-sb-validations="required," />
            </p>
                          <p>
                            <input class="form-control" id="email" type="email" placeholder="อีเมล" data-sb-validations="required,email" />
                          </p>
                            <p>&nbsp; </p>
          </div>
			   <!-- Submit Button-->
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="#page-top"> Register</a> 
                        ...
                        <div class="d-none" id="submitSuccessMessage2">
                          <div class="text-center text-white mb-3">
                            <div class="fw-bolder">Form submission successful!</div><!-- Footer-->
