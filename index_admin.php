                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Advice</a></li>
                      ...
                      <li class="nav-item"><a class="nav-link" href="#team">Patient information</a></li>
                      <li class="nav-item"><a class="nav-link" href="#contact">Advise for patient</a></li>
					  <li class="nav-item"><a class="nav-link" href="ad.php">Profile</a></li>
					  <li class="nav-item"><a class="nav-link" href="regis_Admin.php">Register</a></li>
                  </ul>
                </div>
          </div>
        </nav>
    ...
    <!-- Masthead-->
        ...
        <section class="page-section" id="contact">
          <div class="container">
            ...
            <p>
              <input class="form-control" id="number" type="number" placeholder="เบอร์โทรศัพท์" data-sb-validations="required," />
            </p>
            <p>
              <input class="form-control" id="text4" type="text" placeholder="ที่อยู่" data-sb-validations="required," />
            </p>
            <p>
