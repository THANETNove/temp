...
h1 {
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                     ...
                     <li class="nav-item"><a class="nav-link" href="pa_pro.php">Profile</a></li>
                      <li class="nav-item"><a class="nav-link" href="index_user.php">Register</a></li>
                  </ul>
                </div>
          </div>
        </nav>
    ...
    <div class="text-center">
        <h2 class="section-heading text-uppercase">Sign in</h2>
                    <h3 class="section-subheading text-muted">choose for login</h3>
    </div>
    
    <div class="row text-center"> 
        <div class="col-md-4"> 
            <a href="login_patient.php">
                <img src="img/patient.png" width="160" height="160" alt=""/>
        ...
        <div class="col-md-4">
            <a href="login_doctor.php">
                <img src="img/doctor.png" width="160" height="160" alt=""/>
