...
<body id="page-top">
    ...
    <section class="page-section" id="question">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">คำถามที่พบบ่อยและคำตอบจากผู้เชี่ยวชาญ</h3>
                <?php
    ...
    <section class="page-section" id="makeDoctor">
        ...
        LEFT JOIN users u ON ap.doctor_id = u.id
        WHERE ap.user_id = $user_id
        ...
        <div>
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">เริ่มต้นการนัดหมายกับแพทย์ เพื่อรับคำแนะนำเฉพาะสำหรับคุณ</h3>

            </div>
            <div class="container">
                <h2 class="mb-4 text-uppercase">📅 นัดหมายแพทย์</h2>

                <form action="insert_appointment.php" method="POST">
                    <input type="hidden" name="user_id" value="<?= $user_id ?>">

                    <div class="mb-3">
                        <label for="appointment_date" class="form-label">วันที่ต้องการนัด:</label>
                        <input type="date" name="appointment_date" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label for="appointment_time" class="form-label">เวลาที่ต้องการ:</label>
                        <input type="time" name="appointment_time" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label for="symptoms" class="form-label">อาการหรือเหตุผลที่ต้องการปรึกษา:</label>
                        <textarea name="symptoms" class="form-control" rows="4"
                            placeholder="ปวดศีรษะ น้ำตาลสูง ฯลฯ"></textarea>
                    </div>
